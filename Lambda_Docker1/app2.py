...
def resize_image_array(img_arr, cfg):
...
#         temp = json.loads(predict(base64_decoded))


        
#         uri = temp["mask_rcnn_pred"]
#         total_cost = temp["total_cost"]
#         yolo_total_cost = temp["yolo_total_cost"]
#         yolo_uri = temp["yolo_pred"]
...
def predict(event, context):
    ...
    # base64_decoded = base64.b64decode(eval(image_string))
    base64_decoded = base64.b64decode(image_string)
    image = array(Image.open(BytesIO(base64_decoded)))
    ...
    result = {
        ...
        "yolo_total_cost": yolo_total_cost,
        "yolo_pred": yolo_uri
    }
